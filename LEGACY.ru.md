# wb-mcp-server — архивная документация

> **Это историческая документация. Не используйте инструкции по установке и
> настройке ниже.** Актуальный установщик Artel AI и руководство доступны на
> [artelai.ru/product](https://artelai.ru/product/) и в боте
